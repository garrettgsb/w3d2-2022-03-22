...
function getBlogsForAuthor(author) {
  return blogs.filter(blog => blog.author.toLowerCase() === author.toLowerCase());
}
...
function createBlog(author, title, body) {
  blogs.push({id: nextId(), author, title, body});
}
